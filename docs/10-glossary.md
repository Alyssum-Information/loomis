...
| **device.json** | The `.loomis/device.json` registration file written to a recorder's volume. [05 §2](05-data-model-and-storage.md#2-on-device-registration-file--devicejson) |
